  ...
  ({ className, label, type, ...props }, ref) => {
    return (
      <div className="relative w-full">
        {label && (
          <label className="absolute left-2 top-1 text-xs font-medium text-gray-800 bg-white px-1 z-10">
            {label}
          </label>
        )}
        <input
