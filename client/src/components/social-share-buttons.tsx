  ...
  return (
    <div className="fixed right-0 top-[45px] z-30 flex flex-col gap-2 p-1.5 bg-transparent rounded-l-md">
      ...
      <button
        ...
        className="w-8 h-8 flex items-center justify-center rounded-full bg-white text-black hover:bg-gray-100 transition-colors shadow-md"
        aria-label="Share"
        title="Share"
      >
        {/* Share icon matching the provided design */}
