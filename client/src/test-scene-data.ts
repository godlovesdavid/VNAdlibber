...
export const testSceneData: GeneratedAct = {
  "scene1": {
    ...
    "image_prompt": "A warm, inviting café with large windows showing rain outside, soft lighting, wooden tables, and shelves of books along one wall",
    "dialogue": [
  ...
  "scene5": {
    ...
    "image_prompt": "The entrance of a café with a striped awning, rain pouring down around it, two people standing close together watching the rain, city street visible beyond",
    "dialogue": [
  ...
  "scene6": {
    ...
    "image_prompt": "The front of a café with rain-slicked streets, the sky beginning to clear, two people standing at a distance from each other in front of the café",
    "dialogue": [
